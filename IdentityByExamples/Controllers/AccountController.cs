...
namespace Test.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordModel forgotPasswordModel)
        {
            ...
            // Si el usuario es encontrado comparamos el email y la fecha de cumpleaños, para poder enviar el correo 
            if (user.Email == forgotPasswordModel.Email && user.BirthDate == forgotPasswordModel.BirthDate){
